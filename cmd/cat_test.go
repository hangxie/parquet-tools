...
func TestCatCmd(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"nested-schema-csv":      {cmd: CatCmd{ReadOption: rOpt, Skip: 10, Limit: 10, ReadPageSize: 10, SampleRatio: 0.5, Format: "csv", NoHeader: true, URI: "../testdata/all-types.parquet"}, errMsg: "field [Variant] is not scalar type"},
		"nested-schema-tsv":      {cmd: CatCmd{ReadOption: rOpt, Skip: 10, Limit: 10, ReadPageSize: 10, SampleRatio: 0.5, Format: "tsv", NoHeader: true, URI: "../testdata/all-types.parquet"}, errMsg: "field [Variant] is not scalar type"},
