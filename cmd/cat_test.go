...
func Test_CatCmd_Run_error(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"nested-schema-csv":      {CatCmd{ReadOption: rOpt, Skip: 10, SkipPageSize: 10, Limit: 10, ReadPageSize: 10, SampleRatio: 0.5, Format: "csv", NoHeader: true, URI: fileName, FailOnInt96: false, Concurrent: false}, "field [Map] is not scalar type"},
		"nested-schema-tsv":      {CatCmd{ReadOption: rOpt, Skip: 10, SkipPageSize: 10, Limit: 10, ReadPageSize: 10, SampleRatio: 0.5, Format: "tsv", NoHeader: true, URI: fileName, FailOnInt96: false, Concurrent: false}, "field [Map] is not scalar type"},
		"geospatial-csv":         {CatCmd{ReadOption: rOpt, Skip: 10, SkipPageSize: 10, Limit: 10, ReadPageSize: 10, SampleRatio: 0.5, Format: "csv", NoHeader: true, URI: "../testdata/geospatial.parquet", FailOnInt96: false, Concurrent: false}, "field [Geometry] is not scalar type"},
...
func Test_CatCmd_Run_good(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"skip-2":             {CatCmd{ReadOption: rOpt, Skip: 2, SkipPageSize: 10, Limit: 0, ReadPageSize: 10, SampleRatio: 1.0, Format: "json", NoHeader: false, URI: "good.parquet", FailOnInt96: false, Concurrent: true}, "cat-good-json-skip-2.json"},
