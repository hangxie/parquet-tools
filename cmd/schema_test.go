...
func Test_SchemaCmd_typeStr_both_nil(t *testing.T) {
	assert.Equal(t, typeStr(parquet.SchemaElement{Type: nil, ConvertedType: nil}), "STRUCT")
}
...
func Test_SchemaCmd_Run_good_go(t *testing.T) {
	...
	assert.Equal(t, stdout, strings.Join([]string{
