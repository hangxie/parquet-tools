...
func TestSchemaCmd(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"no-page-encoding":     {cmd: SchemaCmd{ReadOption: rOpt, Format: "json", NoPageEncoding: true, URI: "good.parquet"}, golden: "schema-good-no-page-encoding.json"},
		"no-page-encoding-raw": {cmd: SchemaCmd{ReadOption: rOpt, Format: "raw", NoPageEncoding: true, URI: "good.parquet"}, golden: "schema-good-no-page-encoding-raw.json"},
		"no-page-encoding-go":  {cmd: SchemaCmd{ReadOption: rOpt, Format: "go", NoPageEncoding: true, URI: "good.parquet"}, golden: "schema-good-no-page-encoding-go.txt"},
