...
func Test_SchemaCmd_Run_good_invalid_format(t *testing.T) {
	cmd := &SchemaCmd{
		CommonOption: CommonOption{
...
func Test_SchemaCmd_Run_good_go(t *testing.T) {
	...
	out, _ := ioutil.ReadAll(r)
	os.Stdout = savedStdout
	assert.Equal(t, string(out), `TBD`+
		"\n")
}
func Test_SchemaCmd_typeStr(t *testing.T) {
