...
func TestSchemaCmd(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"skip-page-encoding":     {cmd: SchemaCmd{ReadOption: rOpt, Format: "json", SkipPageEncoding: true, URI: "good.parquet"}, golden: "schema-good-skip-page-encoding.json"},
		"skip-page-encoding-raw": {cmd: SchemaCmd{ReadOption: rOpt, Format: "raw", SkipPageEncoding: true, URI: "good.parquet"}, golden: "schema-good-skip-page-encoding-raw.json"},
		"skip-page-encoding-go":  {cmd: SchemaCmd{ReadOption: rOpt, Format: "go", SkipPageEncoding: true, URI: "good.parquet"}, golden: "schema-good-skip-page-encoding-go.txt"},
		"show-compression":       {cmd: SchemaCmd{ReadOption: rOpt, Format: "json", ShowCompressionCodec: true, URI: "good.parquet"}, golden: "schema-good-show-compression-codec.json"},
		"show-compression-raw":   {cmd: SchemaCmd{ReadOption: rOpt, Format: "raw", ShowCompressionCodec: true, URI: "good.parquet"}, golden: "schema-good-show-compression-codec-raw.json"},
		"show-compression-go":    {cmd: SchemaCmd{ReadOption: rOpt, Format: "go", ShowCompressionCodec: true, URI: "good.parquet"}, golden: "schema-good-show-compression-codec-go.txt"},
	}
